...
public enum ErrorCode {
    ...
    SIGNUP_EMAIL_EXCEED(402,"회원가입 이메일 재 인증 횟수 초과"),
    SIGNUP_SMS_VERIFY_CODE_FAILED(404,"회원가입 sms 문자 인증 실패" ),
    SIGNUP_EMAIL_VERIFY_CODE_FAILED(404,"회원가입 이메일 인증 실패" ),
    SIGNUP_CERT_CODE_UNVERIFIED(405,"회원가입 인증코드 미인증" ),
    SIGNUP_EMAIL_DUPLICATE(406,"회원가입 이메일이 중복되었습니다."),
    SIGNUP_SMS_DUPLICATE(407,"회원가입 휴대폰번호가 중복되었습니다.");
